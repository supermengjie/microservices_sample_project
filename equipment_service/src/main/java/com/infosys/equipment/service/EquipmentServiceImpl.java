...
public class EquipmentServiceImpl implements EquipmentService{
	...
	public List<EquipmentDTO> findEquipmentByCustomerId(int customerId) {
		...
		logger.info("Equipment for customerId {} : {}", customerId, lEquipments );
		return lEquipments;
	}
	...
	public List<EquipmentDTO> findEquipment() {
		logger.info("Equipment request for all equipments");
		...
		logger.info("Equipment for all equipments {}", lEquipments);
		return lEquipments;
